...
AjaxSolr.CountryCodeWidget = AjaxSolr.AbstractFacetWidget.extend({
  afterRequest: function () {
    ...
    $(this.target).append(AjaxSolr.theme('select_tag', 'license', AjaxSolr.theme('options_for_select', maps)));
    ...
    $(this.target).append(AjaxSolr.theme('select_tag', 'license', AjaxSolr.theme('options_for_select', options)));
